...
def main():
    """
    Development tasks for python-boilerplate
...
def autopep8(auto_commit):
    ...
    shell('autopep8 -i -r python_boilerplate/ tests/')
...
def clean_build():
    ...
    click.confirm('This will uninstall the python_boilerplate cli. '
...
def test(capture, pdb, mypy):
    ...
    if mypy:
        shell('mypy python_boilerplate tests/')
